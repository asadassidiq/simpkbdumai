...
class LaporanController extends Controller
{
    ...
    public function printlaporanloketpendaftaranbulanan($tgl)
    {
        ...
        foreach ($jenispengujian as $list) {
            ...
            $arr = array(
                    ...
                    'blangko'  => Pendaftaran::leftJoin('transaksis','transaksis.pendaftaran_id','=','pendaftarans.id')->where('kodepenerbitans_id',$jenis)->whereMonth('tglpendaftaran',$bulan)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->sum('blangko'),
        ...
        foreach ($merek as $list) {
            $arr = array(
                    'merek'          => $list->merek,
                    'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('merek',$list->merek)->where('klasifikasis_id','2')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'mobilbis'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('merek',$list->merek)->where('klasifikasis_id','3')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'mobilbarang'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('merek',$list->merek)->where('klasifikasis_id','4')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'keretatempelan' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('merek',$list->merek)->where('klasifikasis_id','6')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'keretagandeng'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('merek',$list->merek)->where('klasifikasis_id','5')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'kendaraankhusus'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('merek',$list->merek)->where('klasifikasis_id','7')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                );
        ...
        foreach ($jbb as $list) {
            ...
            $arr = array(
                ...
                'jbb'           => $jbb,
                'daya'          => $daya,
                    'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('jbb','>=',$jbb1)->where('jbb','<=',$jbb2)->where('klasifikasis_id','2')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'mobilbis'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('jbb','>=',$jbb1)->where('jbb','<=',$jbb2)->where('klasifikasis_id','3')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'mobilbarang'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('jbb','>=',$jbb1)->where('jbb','<=',$jbb2)->where('klasifikasis_id','4')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'keretatempelan' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('jbb','>=',$jbb1)->where('jbb','<=',$jbb2)->where('klasifikasis_id','6')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'keretagandeng'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('jbb','>=',$jbb1)->where('jbb','<=',$jbb2)->where('klasifikasis_id','5')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                    'kendaraankhusus'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->whereMonth('tglpendaftaran',$bulan)->where('jbb','>=',$jbb1)->where('jbb','<=',$jbb2)->where('klasifikasis_id','7')->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(),
                );
        ...
        foreach ($wilayah as $list) {
            $arr = array(
                    'wilayah'        => $list,
                    'mobilpenumpangumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbisumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbarangumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretatempelanumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretagandengumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'kendaraankhususumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilpenumpangtidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbistidakumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbarangtidakumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretatempelantidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretagandengtidakumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'kendaraankhusustidakumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                );
            array_push($totalwilayahnu, $arr);
        }

        $wilayahnu = Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('peruntukan','Umum')->where('namawilayah','like','%'.'DUMAI'.'%')->where('kodepenerbitans_id','5')->get();
        $totalwilayahnuall = array();
        foreach ($wilayahnu as $list) {
            $arr = array(
                    'wilayah'        => $list->namawilayah,
                    'mobilpenumpangumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbisumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbarangumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretatempelanumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretagandengumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'kendaraankhususumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilpenumpangtidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbistidakumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'mobilbarangtidakumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretatempelantidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'keretagandengtidakumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                    'kendaraankhusustidakumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','5')->count(),
                );
        ...
        foreach ($wilayahmu as $list) {
            $arr = array(
                    'wilayah'        => $list,
                    'mobilpenumpangumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbisumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbarangumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretatempelanumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretagandengumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'kendaraankhususumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilpenumpangtidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbistidakumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbarangtidakumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretatempelantidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretagandengtidakumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'kendaraankhusustidakumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                );
        ...
        foreach ($wilayahmu as $list) {
            $arr = array(
                    'wilayah'        => $list->namawilayah,
                    'mobilpenumpangumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbisumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbarangumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretatempelanumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretagandengumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'kendaraankhususumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilpenumpangtidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','2')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbistidakumum'       => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','3')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'mobilbarangtidakumum'    => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','4')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretatempelantidakumum' => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','6')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'keretagandengtidakumum'  => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','5')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                    'kendaraankhusustidakumum'=> Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('jenis','jenis.jenis','=','identitaskendaraans.jenis')->leftJoin('kodewilayah','kodewilayah.kodewilayah','=','identitaskendaraans.kodewilayah')->whereMonth('tglpendaftaran',$bulan)->where('klasifikasis_id','7')->where('namawilayah','like','%'.$list->namawilayah.'%')->where('peruntukan','Tidak Umum')->where('kodepenerbitans_id','6')->count(),
                );
    ...
    public function printlaporanloketpendaftarantriwulan($tgl1,$tgl2)
    {
        ...
        foreach ($dayaangkutorang as $list) {
            ...
            $arr = array(
                    'dayaangkutorang' => $list,
                    '0-1'             => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','>=',$tahun-1)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '2'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-2)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '3'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-3)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '4'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-4)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '5'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-5)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '6'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-6)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '7'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-7)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '8'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-8)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '9'               => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','=',$tahun-9)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                    '10'              => Pendaftaran::leftJoin('identitaskendaraans','identitaskendaraans.id','=','pendaftarans.identitaskendaraan_id')->leftJoin('datakendaraans','datakendaraans.identitaskendaraan_id','=','identitaskendaraans.id')->whereBetween('tglpendaftaran',[$tglcreate1,$tglcreate2])->where('jenis','like','%'.$jenis.'%')->where('dayaangkutorang','>=',$jmlorang1)->where('dayaangkutorang','<=',$jmlorang2)->where('thpembuatan','<=',$tahun-10)->where('kodepenerbitans_id','!=','7')->where('kodepenerbitans_id','!=','12')->count(), 
                );
            array_push($totaldayaangkutorang, $arr);
        }
