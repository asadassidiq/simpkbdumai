        ...
        fetchPost(id) {
            axios({
                ...
                .then((result) => {
                    ...
                    this.form.beratsumbu1 = this.post.beratsumbu1
                    this.form.beratsumbu2 = this.post.beratsumbu2
                    this.form.beratsumbu3 = this.post.beratsumbu3
                    this.form.beratsumbu4 = this.post.beratsumbu4
