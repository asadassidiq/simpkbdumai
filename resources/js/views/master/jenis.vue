        ...
        <form @submit.prevent="savePost">
          <v-card>
            ...
            <v-container>
              <v-row class="mx-2">
                <v-col cols="12">
                    <v-text-field v-model="form.jenis" label="jenis" required></v-text-field>
                </v-col>
                <v-col cols="12">
                    <v-autocomplete  :items="klasifikasi" item-text="klasifikasis" 
                      item-value="id" v-model="form.klasifikasi" name="klasifikasi" dense outlined label="klasifikasi">
                    </v-autocomplete>
                </v-col>
              </v-row>
            </v-container>
        ...
        initialize () {
            axios({
                ...
                .then((result) => {
                    ...
                    console.log(result.data.masters)
                }).catch((err) => {
