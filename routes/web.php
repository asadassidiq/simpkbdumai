...
Route::group(['prefix' => 'cetak'], function() {
    ...
    Route::get('/{id}/{id2}/laporanloketpendaftarantriwulan', 'PendaftaranController@printlaporanloketpendaftarantriwulan')->name('laporanloketpendaftaranbulanan.print');
...
Route::get('fotokendaraan/{id}', 'FotoController@getImage')->name('get.image');
